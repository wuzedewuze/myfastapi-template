...
description = """
myfastapi_template API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="myfastapi_template",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://myfastapi_template.com/terms/",
    contact={
        "name": "wuzedewuze",
        "url": "http://myfastapi_template.com/contact/",
        "email": "wuzedewuze@myfastapi_template.com",
    },
    license_info={
        "name": "The Unlicense",
