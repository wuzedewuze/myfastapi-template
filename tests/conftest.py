...
# WARNING: Ensure imports from `myfastapi_template` comes after this line
from myfastapi_template import app, settings, db  # noqa
from myfastapi_template.cli import create_user, cli  # noqa
